رفیق فابریک همانند برنامه اصلی تلگرام از ای پی آی های تلگرام استفاده می کند و مستقیما به سرور اصلی تلگرام متصل می شود و از لحاظ امنیت تفاوتی بین تلگرام و رفیق فابریک وجود ندارد.
